...
set JAVA_VERSION=17
set MAIN_JAR=family.tree-%PROJECT_VERSION%.jar
...
"%JAVA_HOME%\bin\jdeps" ^
  ...
  --print-module-deps target\classes\de\bushnaq\abdalla\family\Application.class > temp.txt
...
call "%JAVA_HOME%\bin\jpackage" ^
  ...
  --vendor "Abdalla Bushnaq" ^
  --copyright "Copyright © 2022 Abdalla Bushnaq." ^
