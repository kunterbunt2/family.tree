...
/**
 * We use following intermediate data structures A map of dependencies mapped to the row number A map of tasks mapped to the row number A map of tasks mapped to category names A map of resources mapped to their names
 *
