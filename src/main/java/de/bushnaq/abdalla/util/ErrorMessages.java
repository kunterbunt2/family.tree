...
public interface ErrorMessages {
	static final String	ERROR_001_PERSON_IS_NOT_VISIBLE		= "Error #001: [%d]%s %s is not visible. A person is visible if he is member of the family or has children with someone from the family.";
	...
	static final String	ERROR_006_OVERLAPPING				= "Error #006. [%d]%s %s is overlapping with [%d]%s %s.";
