...
public interface ErrorMessages {
    String ERROR_001_PERSON_IS_NOT_VISIBLE = "Error #001: %s is not visible. A person is visible if he is a child of a member of the family or has children with someone that is member of the family.";
